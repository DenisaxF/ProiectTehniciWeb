...
CREATE USER denisa WITH ENCRYPTED PASSWORD 'denisa';
GRANT ALL PRIVILEGES ON DATABASE cti_2024 TO denisa ;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO denisa;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO denisa;